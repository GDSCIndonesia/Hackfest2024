				...
				<div className="sessionCol">
					<div className="timeFrame bg-hackBlue greyShadow">
						<div className="timeContent">
							<div>
								<img
									src="/libraries/images/png/peoples/jason.png"
									alt="Jason Jeremy"
								/>
							</div>
				...
				<div className="sessionCol">
					<div className="timeFrame bg-hackRed greyShadow">
						<div className="timeContent">
							<div>
								<img
									src="/libraries/images/png/peoples/abadi.png"
									alt="Abadi Suryo"
								/>
							</div>
							<h1>Info Session HackFest</h1>
				...
				<div className="sessionCol">
					<div className="timeFrame bg-hackGreen greyShadow">
						<div className="timeContent">
							<div>
								<img
									src="/libraries/images/png/peoples/denySalvana.png"
									alt=""
								/>
							</div>
							<h1>Pitching & Product Management</h1>
							<h2>Deny Salvana Ervan</h2>
							<p>Project Manager MTARGET</p>
						</div>
						<div className="flex space-x-2">
							<div className="dateBottom">

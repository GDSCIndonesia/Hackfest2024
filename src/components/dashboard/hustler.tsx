					...
					desc={
						<>
							...
							<p>
								...
								is a single link leading directly to your BMC. We value your
								time, and this streamlined approach will allow us to focus on
								your innovation.
							</p>

							<p>
								<strong>File Format:</strong> Submit your BMC in the form of a
								.zip file. This format ensures that all your necessary documents
								are neatly packaged and easily accessible.
							</p>

							<p>
								<strong>Comprehensive Description:</strong> Your .zip file
								should include a comprehensive description within the BMC
								document itself. Provide detailed insights into each section of
								the BMC, showcasing your strategic thinking, market analysis,
							...
							<ol>
								<li>Package all your BMC documents into a single folder.</li>
								<li>Compress the folder into a .zip file.</li>
								<li>
									Upload the .zip file to your preferred cloud storage platform
									(Google Drive, Dropbox, etc.).
								</li>
								<li>
									Share the link with us via the submission link input form.
								</li>
							</ol>
						</>
					}

...
export default function PopDash() {
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="w-fit h-fit p-8 bg-white border-2 border-black relative" ref={popRef}>
                    ...
                    <div className="min-w-[220px] max-w-[600px] h-fit">
                        <h1 className="text-gooYellow-700 text-center font-gooMed text-[16px] md:text-[20px] lg:text-[23px] mb-2">Hi Folks! For Stage 3, please submit the required links through the form provided in the Summary Page.</h1>
                        <h1 className="text-gooGreen-700 text-center font-gooReg text-[13px] md:text-[16px] lg:text-[18px] mt-6">Make sure the provided links are accurate, and dont forget to submit before 23:59 WIB Thank you!</h1>
                    </div>
                </div>
            </div>
        </div>
